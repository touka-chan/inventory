@echo off
REM Serveo Tunnel for M1 Inventory Frontend
REM Exposes localhost:5173 via a public URL
REM URL format: https://RANDOM.serveo.net
REM Copy the URL and update ..\.env VITE_POS_URL and VITE_DASHBOARD_URL
